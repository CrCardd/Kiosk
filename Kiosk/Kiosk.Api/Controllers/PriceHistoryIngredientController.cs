...
public class PriceHistoryIngredientController(IMediator mediator) : ControllerBase
{
    ...
    FORMAT EXAMPLE:
        -------------------------------------------------------------------------
        [Http[METHOD]]
        public async Task<ActionResult<[SERVICE]PriceHistoryIngredientResponse>> [METHOD](
            [SERVICE]PriceHistoryIngredientRequest request, CancellationToken cancellationToken
        )
        {
